 ...
 * 授权和取消授权演示页面
 * <p>
 * 由于UI显示的需要授权过的平台显示账户的名称， 因此此页面事实上展示的是“获取用户资料”和“取消 授权”两个功能。如果想看纯粹的“授权”操作，请参 考
 * {@link GetTokenPage}页面的相关代码。
 */
...
//		return LayoutInflater.from(getContext()).inflate(R.layout.page_auth,
//				null);
//	}
//
...
//			if (convertView == null) {
//				convertView = View.inflate(page.getContext(),
...
//			int resId = com.mob.tools.utils.R.getBitmapRes(page.getContext(),
//					resName.toLowerCase());
...
//			}
//
//			int resId = com.mob.tools.utils.R.getStringRes(page.getContext(),
//					plat.getName());
...
//			plat.SSOSetting(!CustomShareFieldsPage
//					.getBoolean("enableSSO", true));
