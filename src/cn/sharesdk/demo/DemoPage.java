...
/**
 * ShareSDK 官网地址 ： http://www.mob.com </br> 1、ShareSDK接口演示页面</br>
 * 包括演示使用快捷分享完成图文分享、</br> 无页面直接分享、授权、关注和不同平台的分享等等功能。</br>
 * 
 ...
 */
//public class DemoPage extends SlidingMenuPage implements OnClickListener,
...
//			btn.setSingleLine();
//			int platNameRes = com.mob.tools.utils.R.getStringRes(getContext(),
//					name.toLowerCase());
//			if (platNameRes > 0) {
//				String platName = getContext().getString(platNameRes);
//				String text = getContext().getString(R.string.share_to_format,
//						platName);
//				btn.setText(text);
//			}
//			btn.setTag(platform);
...
//		return LayoutInflater.from(getContext()).inflate(R.layout.page_demo,
//				null);
//	}
//
...
//				// .setPositiveButton(R.string.qq_share_from_qqlogin, new
//				// DialogInterface.OnClickListener() {
//				// public void onClick(DialogInterface dialog, int which) {
//				// shareFromQQLogin = true;
//				// try
//				// {
//				// getContext().getPackageManager().getPackageInfo("com.qzone",
//				// 0);
...
//				// }
//				// })
//				// .setNegativeButton(R.string.qq_share_from_tlogin, new
//				// DialogInterface.OnClickListener() {
//				// public void onClick(DialogInterface dialog, int which) {
